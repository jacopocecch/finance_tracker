...
# Short tokens use \b word boundaries so they don't fire inside longer words
# (e.g. "azion" in "operazione", "gas" in "gasparini", "atm" in "atmosfera").
DEFAULT_RULES = [
    ...
    (r"luce|\bgas\b|enel|eni gas|acqua|\btari\b|internet|tim |vodafone|\bwind\b|fastweb", "Casa", 8),
    (r"esselunga|coop|carrefour|lidl|aldi|eurospin|\bpam\b|conad", "Spesa",      8),
    (r"supermercato|ipermercato|alimentari",                    "Spesa",          7),
    (r"ristorante|pizzeria|trattoria|osteria|mcdonald|burger",  "Ristoranti",     8),
    (r"pasticceria|gelateria|bakery",                           "Pasticceria/Gelateria", 8),
    (r"bar |caffè|caffe |coffee",                               "Bar/Caffè",      7),
    (r"eni |q8|totalerg|shell|ip gas|agip|tamoil",             "Carburante",     9),
    (r"\batm\b|ataf|trenitalia|italo|flixbus|taxi|uber|bolt",  "Trasporti",      8),
    (r"ryanair|easyjet|wizzair|aereo|\bvol[oi]\b",             "Viaggi",         9),
    (r"booking|airbnb|hotel|hostel|b&b",                       "Alloggio",       9),
    (r"amazon|zalando|shein|zara|h&m|ikea|mediaworld",         "Shopping",       8),
    (r"netflix|spotify|disney|prime video|youtube|dazn|\bapple\b", "Abbonamenti", 9),
    ...
    (r"cinema|\buci\b|the space|multisala",                    "Cinema",         8),
    (r"\betf\b|\btitol|\bazion|\bfond[oi]\b|fineco invest|directa", "Investimento", 9),
    (r"revolut|n26|\bwise\b|paypal|satispay|bonifico",         "Trasferimento",  5),
